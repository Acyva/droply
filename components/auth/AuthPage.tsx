          ...
          {isTelegramApp ? (
            <div className="space-y-3">
              <div className="text-center mb-4">
                <p className="text-sm text-stone-600 dark:text-stone-300">Signing in with your Telegram account...</p>
              </div>

              <Button
                onClick={handleTelegramAuth}
                disabled={loading}
                className="w-full bg-0088cc hover:bg-0077bb text-white rounded-lg h-10 font-medium transition-colors"
            ...
            <>
              <div className="flex gap-1 mb-6 p-1 bg-stone-100 dark:bg-stone-800 rounded-lg">
                <button
              ...
              <Button
                ...
                variant="outline"
                className="w-full rounded-lg h-10 border-stone-200 dark:border-stone-700 text-stone-700 dark:text-stone-300 hover:bg-stone-50 dark:hover:bg-stone-800"
              >
